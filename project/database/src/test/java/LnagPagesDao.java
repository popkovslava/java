...
public class LnagPagesDao {
    ...
    public void clean() {
        try (Session session = FACTORY.openSession()) {
            ...
            session.createQuery("delete from LnagPagesEntity ").executeUpdate();
    ...
    public void checkSaveEntity() {
        try (Session session = FACTORY.openSession()) {
            ...
            LangEntity langEntity = session.find(LangEntity.class, session.save(lang));
            PagesEntity pagesEntity = session.find(PagesEntity.class, session.save(page));
            LnagPagesEntity lnagPagesEntity = new LnagPagesEntity(langEntity, pagesEntity);
